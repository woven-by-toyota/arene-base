...
class inline_vector_internal_storage : public inline_vector_internal_non_constexpr_storage<T, Capacity> {
  ...
  using copy_constructor_arg =
      conditional_t<std::is_copy_constructible<T>::value, inline_vector_internal_storage, non_constructible_dummy>;
  ...
  using move_constructor_arg =
      conditional_t<std::is_move_constructible<T>::value, inline_vector_internal_storage, non_constructible_dummy>;
