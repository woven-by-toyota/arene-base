...
class choose_quantity_kind_base<Derived, ParentKindOrOrigin, OriginOrUnit, units_detail::missing> {
  ...
  using actual_parent = conditional_t<!is_quantity_origin_v<ParentKindOrOrigin>, ParentKindOrOrigin, missing>;

  /// @brief The actual origin specified for this quantity kind, or @c missing if there is none
  using actual_origin = conditional_t<
      !is_quantity_kind_v<ParentKindOrOrigin>,
      ParentKindOrOrigin,
      conditional_t<!is_unit_v<OriginOrUnit>, OriginOrUnit, missing>>;

  /// @brief The actual unit type specified for this quantity kind, or @c missing if there is none
  using actual_unit = conditional_t<!is_quantity_origin_v<OriginOrUnit>, OriginOrUnit, missing>;
...
class choose_quantity_kind_base<Derived, ParentKindOrOriginOrUnit, units_detail::missing, units_detail::missing> {
  ...
  /// @brief The actual parent kind specified for this quantity kind, or @c missing if there is none
  using actual_parent = conditional_t<
  ...
  /// @brief The actual origin specified for this quantity kind, or @c missing if there is none
  using actual_origin =
      conditional_t<is_quantity_origin_v<ParentKindOrOriginOrUnit>, ParentKindOrOriginOrUnit, missing>;

  /// @brief The actual unit type specified for this quantity kind, or @c missing if there is none
  using actual_unit = conditional_t<is_unit_v<ParentKindOrOriginOrUnit>, ParentKindOrOriginOrUnit, missing>;
