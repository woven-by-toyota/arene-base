...
class result : result_detail::result_base<T, E> {
 ...
 private:
  ...
  using copy_assign_arg = std::conditional_t<is_copy_assignable, result, non_constructible_dummy>;
  ...
  using deleted_copy_assign_arg = std::conditional_t<is_copy_assignable, non_constructible_dummy, result>;
 ...
 private:
  ...
  /// non_constructible_dummy if not
  using move_assign_arg = std::conditional_t<is_move_assignable, result, non_constructible_dummy>;
  ...
  using deleted_move_assign_arg = std::conditional_t<is_move_assignable, non_constructible_dummy, result>;
