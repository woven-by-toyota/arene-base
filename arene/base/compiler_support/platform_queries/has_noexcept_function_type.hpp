...
#ifndef INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_COMPILER_SUPPORT_PLATFORM_QUERIES_HAS_NOEXCEPT_FUNCTION_TYPE_HPP_
#define INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_COMPILER_SUPPORT_PLATFORM_QUERIES_HAS_NOEXCEPT_FUNCTION_TYPE_HPP_
...
/// @def ARENE_STD_NOEXCEPT_FUNCTION_TYPE
/// @brief A platform support query for testing if @c __cpp_noexcept_function_type is defined.
///
/// Usage:
/// @code{c++}
...
/// 1. If @c ARENE_STD_NOEXCEPT_FUNCTION_TYPE has been explicitly defined via a @c -D flag to the compiler or similar:
///    * @c ARENE_ON if it is truthy
///    * @c ARENE_OFF if it is not truthy.
/// 1. If @c __cpp_noexcept_function_type is defined and its value is @c >=201510L, it is @c ARENE_ON_BY_DEFAULT
/// 1. Otherwise, it is @c ARENE_OFF_BY_DEFAULT

#if defined(ARENE_STD_NOEXCEPT_FUNCTION_TYPE)
#if (ARENE_STD_NOEXCEPT_FUNCTION_TYPE != 0)
#define ARENE_STD_NOEXCEPT_FUNCTION_TYPE_I_ ARENE_ON
#else
#define ARENE_STD_NOEXCEPT_FUNCTION_TYPE_I_ ARENE_OFF
#endif
...
#define ARENE_STD_NOEXCEPT_FUNCTION_TYPE_I_ ARENE_ON_BY_DEFAULT
#else
...
#ifndef ARENE_STD_NOEXCEPT_FUNCTION_TYPE
...
#endif  // INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_COMPILER_SUPPORT_PLATFORM_QUERIES_HAS_NOEXCEPT_FUNCTION_TYPE_HPP_
