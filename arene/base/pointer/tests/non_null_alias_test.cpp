...
#include "arene/base/pointer/non_null.hpp"
...
using fancy_pointer_types = ::testing::
    Types<std::shared_ptr<int>, std::shared_ptr<int const>, std::unique_ptr<int>, std::unique_ptr<int const>>;

using copyable_pointer_types = ::testing::Types<std::shared_ptr<int>, std::shared_ptr<int const>>;

using movable_pointer_types = ::testing::
    Types<std::shared_ptr<int>, std::shared_ptr<int const>, std::unique_ptr<int>, std::unique_ptr<int const>>;
...
using all_pointer_types = ::testing::
    Types<std::shared_ptr<int>, std::shared_ptr<int const>, std::unique_ptr<int>, std::unique_ptr<int const>>;
...
TEST(NonNullConversions, CanBeExplicitlyConvertedToPointerConvertibleFromHeld) {
  ...
  EXPECT_NO_THROW(std::shared_ptr<base const> const const_base_sptr_from_derived{std::move(derived_non_null_uptr)});
}
