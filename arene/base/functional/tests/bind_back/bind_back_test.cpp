...
TEST_F(BindBackTest, ReturnsAnInvocableWhichIsTheInputInvocableWithTheFirstNArgumentsCurried) {
  ...
  STATIC_ASSERT_TRUE(arene::base::
                         is_invocable_v<decltype(bind_back(function_object_n_argument{})), arg1t, arg2t, arg3t>);
  STATIC_ASSERT_TRUE(arene::base::
                         is_invocable_v<decltype(bind_back(function_object_n_argument{}, arg3t{})), arg1t, arg2t>);
  STATIC_ASSERT_TRUE(arene::base::
                         is_invocable_v<decltype(bind_back(function_object_n_argument{}, arg2t{}, arg3t{})), arg1t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<
                     decltype(bind_back(function_object_n_argument{}, arg1t{}, arg2t{}, arg3t{}))>);

  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<decltype(bind_back(lambda_callable())), arg1t, arg2t, arg3t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<decltype(bind_back(lambda_callable(), arg3t{})), arg1t, arg2t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<decltype(bind_back(lambda_callable(), arg2t{}, arg3t{})), arg1t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<decltype(bind_back(lambda_callable(), arg1t{}, arg2t{}, arg3t{}))>);

  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<
                     decltype(bind_back(&member_function_pointer::do_stuff)),
                     member_function_pointer*,
                     arg1t,
                     arg2t,
                     arg3t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<
                     decltype(bind_back(&member_function_pointer::do_stuff, arg3t{})),
                     member_function_pointer*,
                     arg1t,
                     arg2t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<
                     decltype(bind_back(&member_function_pointer::do_stuff, arg2t{}, arg3t{})),
                     member_function_pointer*,
                     arg1t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_v<decltype(bind_back(
...
TEST_F(BindBackTest, BoundArgumentMismatchIsNotAnErrorButDoesNotHaveCallOverloads) {
  ...
  auto const extra_arg_mf =
      bind_back(&member_function_pointer::do_stuff, member_function_pointer{}, arg1t{}, arg2t{}, arg3t{}, 0U);
  ...
  auto const wrong_arg_mf =
      bind_back(&member_function_pointer::do_stuff, member_function_pointer{}, arg1t{}, arg3t{}, arg2t{});
...
TEST_F(BindBackTest, TheRefQualificationOfTheReturnFromTheInputCallableIsRetained) {
  ...
  STATIC_ASSERT_TRUE(arene::base::is_invocable_r_v<
                     rtype,
                     decltype(bind_back(function_object_n_argument{})),
                     arg1t,
                     arg2t,
                     arg3t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_r_v<
                     rtype,
                     decltype(bind_back(function_object_n_argument{}, arg3t{})),
                     arg1t,
                     arg2t>);
  STATIC_ASSERT_TRUE(arene::base::is_invocable_r_v<
                     rtype,
  ...
  STATIC_ASSERT_TRUE(arene::base::is_invocable_r_v<rtype, decltype(bind_back(lambda_callable())), arg1t, arg2t, arg3t>);
  STATIC_ASSERT_TRUE(arene::base::
                         is_invocable_r_v<rtype, decltype(bind_back(lambda_callable(), arg3t{})), arg1t, arg2t>);
  STATIC_ASSERT_TRUE(arene::base::
                         is_invocable_r_v<rtype, decltype(bind_back(lambda_callable(), arg2t{}, arg3t{})), arg1t>);
  STATIC_ASSERT_TRUE(arene::base::
                         is_invocable_r_v<rtype, decltype(bind_back(lambda_callable(), arg1t{}, arg2t{}, arg3t{}))>);
...
TEST_F(BindBackTest, TheNoexceptnessOfTheInputCallableIsPreserved) {
  ...
  STATIC_ASSERT_EQ(
      (arene::base::is_nothrow_invocable_v<some_args_curried_floatptr&, float*>),
      (arene::base::is_nothrow_invocable_v<callable_with_arg_and_ref_based_noexcept&, float*, float*>)
  );
  STATIC_ASSERT_EQ(
      (arene::base::is_nothrow_invocable_v<some_args_curried_floatptr const&, float*>),
      (arene::base::is_nothrow_invocable_v<callable_with_arg_and_ref_based_noexcept const&, float*, float*>)
  );
  STATIC_ASSERT_EQ(
      (arene::base::is_nothrow_invocable_v<some_args_curried_floatptr&&, float*>),
  ...
  STATIC_ASSERT_EQ(
      (arene::base::is_nothrow_invocable_v<all_args_curried_floatptr&>),
      (arene::base::is_nothrow_invocable_v<callable_with_arg_and_ref_based_noexcept&, float*, float*>)
  );
  STATIC_ASSERT_EQ(
      (arene::base::is_nothrow_invocable_v<all_args_curried_floatptr const&>),
      (arene::base::is_nothrow_invocable_v<callable_with_arg_and_ref_based_noexcept const&, float*, float*>)
  );
  STATIC_ASSERT_EQ(
      (arene::base::is_nothrow_invocable_v<all_args_curried_floatptr&&>),
...
TEST_F(BindBackTest, TheReferenceQualificationOfTheReturnedCallableIsAppliedToTheBoundArguments) {
  std::string const bound_last_arg_initial_state = "foo";

  auto const last_arg_must_be_rvalue = [](std::string const& lhs, std::string&& rhs) -> std::string {
  ...
  EXPECT_EQ(std::move(only_invocable_if_moved)("bar"), std::string{"bar"} + bound_last_arg_initial_state);

  auto const last_arg_must_be_non_const_lvalue = [](std::string const& lhs, std::string& rhs) -> std::string {
    rhs += lhs;
    return rhs;
  };
