...
class bind_back_t
    : functional_detail::perfect_forward_call_wrapper<bind_back_policy<sizeof...(BoundArgs)>, BoundFunc, BoundArgs...> {
  /// @brief specialization of perfect_forward_call_wrapper that binds arguments to the back
  using impl_type =
      functional_detail::perfect_forward_call_wrapper<bind_back_policy<sizeof...(BoundArgs)>, BoundFunc, BoundArgs...>;
...
/// @brief function object implementing bind_back
class bind_back_fn {
 public:
  ...
  /// into the bound callable. Similarly, if @c f were to have non-const lvalue parameters at the position of bound
...
/// @def arene::base::bind_back
/// @copydoc arene::base::bind_back_detail::bind_back_fn::operator()
