...
class bind_front_t
 ...
 public:
  using functional_detail::perfect_forward_call_wrapper<
      bind_front_policy<sizeof...(BoundArgs)>,
      BoundFunc,
...
/// the bound callable. Similarly, if @c f where to have non-const lvalue parameters for at the position of bound
...
template <typename BoundFunc, typename... BoundArgs>
constexpr auto bind_front(BoundFunc&& bound_func, BoundArgs&&... bound_args) noexcept(
