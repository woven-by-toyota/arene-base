...
#ifndef INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_BYTE_SWAP16_BSWAP16_HPP_
#define INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_BYTE_SWAP16_BSWAP16_HPP_
...
/// @brief Implementation helper for @c arene::base::byte_swap(std::uint16_t) when @c __builtin_bswap16 exists
...
#endif  // INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_BYTE_SWAP16_BSWAP16_HPP_
