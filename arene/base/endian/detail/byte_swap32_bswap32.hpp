...
#ifndef INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_BYTE_SWAP32_BSWAP32_HPP_
#define INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_BYTE_SWAP32_BSWAP32_HPP_
...
/// @brief Implementation helper for @c arene::base::byte_swap(std::uint32_t) when @c __builtin_bswap32 exists
...
#endif  // INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_BYTE_SWAP32_BSWAP32_HPP_
