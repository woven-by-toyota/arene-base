...
#ifndef INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_ENDIAN_GENERIC_IMPL_HPP_
#define INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_ENDIAN_GENERIC_IMPL_HPP_
...
enum class endian : std::uint8_t {
  ...
  native   //< The native byte-order of the system architecture.
};
}  // namespace base
}  // namespace arene

#endif  // INCLUDE_GUARD_ARENE_BASE_ARENE_BASE_ENDIAN_DETAIL_ENDIAN_GENERIC_IMPL_HPP_
