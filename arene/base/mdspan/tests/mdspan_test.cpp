...
CONSTEXPR_TYPED_TEST(MdspanTestSuite, MdspanCanBeCopyConstructedFromAnotherMdspan) {
  ...
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().copy_ctor_count, 1U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().move_ctor_count, 0U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().copy_assign_count, 0U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().move_assign_count, 0U);
}
...
CONSTEXPR_TYPED_TEST(MdspanTestSuite, MdspanCanBeCopyAssignedFromAnotherMdspan) {
  ...
  CONSTEXPR_ASSERT(mdspan_has_expected_properties(copied_span));
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().copy_ctor_count, 0U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().move_ctor_count, 0U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().copy_assign_count, 1U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().move_assign_count, 0U);
}
...
CONSTEXPR_TYPED_TEST(MdspanTestSuite, MdspanCanBeMoveConstructedFromAnotherMdspan) {
  ...
  CONSTEXPR_ASSERT_EQ(moved_span.accessor().copy_ctor_count, 0U);
  CONSTEXPR_ASSERT_EQ(moved_span.accessor().move_ctor_count, 1U);
  CONSTEXPR_ASSERT_EQ(moved_span.accessor().copy_assign_count, 0U);
  CONSTEXPR_ASSERT_EQ(moved_span.accessor().move_assign_count, 0U);
}
...
CONSTEXPR_TYPED_TEST(MdspanTestSuite, MdspanCanBeMoveAssignedFromAnotherMdspan) {
  ...
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().move_ctor_count, 0U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().copy_assign_count, 0U);
  CONSTEXPR_ASSERT_EQ(copied_span.accessor().move_assign_count, 1U);
}
...
/// @test The @c is_mdspan_v type trait is true for all of the test mdspan types and false for their various pieces
TYPED_TEST(MdspanTestSuite, AllMdspansAreIdentifiedByIsMdspanV) {
  STATIC_ASSERT_TRUE(arene::base::is_mdspan_v<TypeParam>);
  STATIC_ASSERT_TRUE(arene::base::is_mdspan_v<TypeParam const>);
  STATIC_ASSERT_TRUE(arene::base::is_mdspan_v<TypeParam volatile>);
  STATIC_ASSERT_TRUE(arene::base::is_mdspan_v<TypeParam const volatile>);

  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::extents_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::layout_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::accessor_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::mapping_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::element_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::value_type>);

  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::index_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::size_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::rank_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::data_handle_type>);
  STATIC_ASSERT_FALSE(arene::base::is_mdspan_v<typename TypeParam::reference>);
}
