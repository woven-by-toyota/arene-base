...
CONSTEXPR_TYPED_TEST(ExtentsTypedTest, RankIsCountOfExtents) {
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, 1, 2, 3, arene::base::dynamic_extent, 42>::rank()), 5);
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, 1, arene::base::dynamic_extent, 42>::rank()), 3);
  CONSTEXPR_ASSERT_EQ(arene::base::extents<TypeParam>::rank(), 0);
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, arene::base::dynamic_extent>::rank()), 1);
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, 99>::rank()), 1);
}
...
CONSTEXPR_TYPED_TEST(ExtentsTypedTest, DynamicRankIsNumberOfDynamicExtents) {
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, 1, 2, 3, arene::base::dynamic_extent, 42>::rank_dynamic()), 1);
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, 1, arene::base::dynamic_extent, 42>::rank_dynamic()), 1);
  CONSTEXPR_ASSERT_EQ(arene::base::extents<TypeParam>::rank_dynamic(), 0);
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, arene::base::dynamic_extent>::rank_dynamic()), 1);
  CONSTEXPR_ASSERT_EQ((arene::base::extents<TypeParam, 99>::rank_dynamic()), 0);
  CONSTEXPR_ASSERT_EQ(
...
CONSTEXPR_TYPED_TEST(ExtentsTypedTest, ExtentReturnsTheActualExtentForAllStaticExtents) {
  ...
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(0), 1);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(1), 3);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(2), 6);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(3), 7);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(4), 9);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(5), 10);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(6), 11);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(7), 12);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(8), 13);
}
...
TYPED_TEST(ExtentsTypedTest, ExtentReturnsTheActualExtentForAllStaticExtentsAtRuntime) {
  ...
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(0), 1);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(1), 2);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(2), 3);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(3), 40);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(4), 50);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(5), 6);
}
...
CONSTEXPR_TYPED_TEST(ExtentsTypedTest, ExtentReturnsTheActualExtentForASingleDynamicExtent) {
  ...
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(0), 1);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(1), chosen_extent);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(2), 6);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(3), 7);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(4), 9);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(5), 10);
...
CONSTEXPR_TYPED_TEST(ExtentsTypedTest, DefaultExtentsForDynamicExtentsIsZero) {
  ...
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(0), 0);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(1), 1);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(2), 0);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(3), 3);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(4), 0);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(5), 0);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(6), 6);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(7), 7);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(8), 0);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(9), 9);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(10), 10);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(11), 11);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(12), 12);
...
CONSTEXPR_TYPED_TEST(ExtentsTypedTest, CanPassOnlyDynamicExtentsBySpanWhenAllExtentsAreStatic) {
  ...
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(0), chosen_extent1);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(1), chosen_extent2);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(2), chosen_extent3);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(3), chosen_extent4);
  CONSTEXPR_ASSERT_EQ(extent_var1.extent(4), chosen_extent5);
}
