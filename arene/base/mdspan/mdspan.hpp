...
namespace is_mdspan_detail {
/// @brief Type trait to determine if the given type is an mdspan of some kind
/// @tparam T The type to check
template <typename T>
extern constexpr bool is_mdspan_v{false};
...
template <typename ElementType, typename Extents, typename LayoutPolicy, typename AccessorPolicy>
extern constexpr bool is_mdspan_v<mdspan<ElementType, Extents, LayoutPolicy, AccessorPolicy>>{true};
}  // namespace is_mdspan_detail

/// @brief Type trait to determine if the given type is an mdspan of some kind
/// @tparam T The type to check
template <typename T>
extern constexpr bool is_mdspan_v{is_mdspan_detail::is_mdspan_v<std::remove_cv_t<T>>};
