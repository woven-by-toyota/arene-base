...
// parasoft-begin-suppress AUTOSAR-A0_1_3-a "False positive: this function is used below within a constant expression"
/// @brief helper function to generate a hard error if argument type is not a submdspan slice for an index type
