...
constexpr auto any_equal(Range1 const& range1, Range2 const& range2) -> bool {
...
class submdspan_offset_fn  //
{
 public:
  ...
  /// @pre @c sizeof...(CanonicalSliceSpecifiers) == LayoutMapping::extents_type::rank()
  ...
  constexpr auto operator()(LayoutMapping const& mapping, CanonicalSliceSpecifiers const&... slices) const noexcept
    ...
    auto const lower_bounds =
        array<index_type, sizeof...(CanonicalSliceSpecifiers)>{slice_lower_bound<index_type>(slices)...};
