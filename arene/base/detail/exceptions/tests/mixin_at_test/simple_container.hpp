...
class simple_container : public arene::base::detail::mixin_at<simple_container<IndexReturnType, N>, std::size_t> {
  ...
  using lvalue_index_return_type =
      arene::base::conditional_t<std::is_reference<IndexReturnType>::value, value_type&, value_type>;
  using clvalue_index_return_type =
      arene::base::conditional_t<std::is_reference<IndexReturnType>::value, value_type const&, value_type>;
