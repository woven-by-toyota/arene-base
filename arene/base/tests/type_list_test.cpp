...
/// @test `cartesian_product` is declared
TEST(TypeList, CartesianProduct) { using arene::base::type_lists::cartesian_product; }

/// @test `cartesian_product_t` is declared
TEST(TypeList, CartesianProductT) { using arene::base::type_lists::cartesian_product_t; }

/// @test `cartesian_product_as` is declared
TEST(TypeList, CartesianProductAs) { using arene::base::type_lists::cartesian_product_as; }

/// @test `cartesian_product_as_t` is declared
TEST(TypeList, CartesianProductAsT) { using arene::base::type_lists::cartesian_product_as_t; }
...
/// @test `reverse` is declared
TEST(TypeList, Reverse) { using arene::base::type_lists::reverse; }

/// @test `reverse_t` is declared
TEST(TypeList, ReverseT) { using arene::base::type_lists::reverse_t; }
