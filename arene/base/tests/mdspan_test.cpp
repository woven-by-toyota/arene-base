...
/// @test `is_mdspan_v` is declared
TEST(Mdspan, IsMdspanVIsDeclared) { using arene::base::is_mdspan_v; }
...
/// @test `submdspan` is declared
TEST(Mdspan, Submdspan) { using arene::base::submdspan; }
