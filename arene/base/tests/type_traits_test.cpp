...
/// @test `conditional_t` is declared
TEST(TypeTraits, ConditionalT) { using arene::base::conditional_t; }
/// @test `conditional_identity_t` is declared
TEST(TypeTraits, ConditionalIdentityT) { using arene::base::conditional_identity_t; }
/// @test `conditional_apply_t` is declared
TEST(TypeTraits, ConditionalApplyT) { using arene::base::conditional_apply_t; }
...
/// @test `give_cv_to` is declared
TEST(TypeTraits, GiveCvTo) { using arene::base::give_cv_to; }
/// @test `give_cv_to_t` is declared
TEST(TypeTraits, GiveCvToT) { using arene::base::give_cv_to_t; }

/// @test `give_cvref_to` is declared
TEST(TypeTraits, GiveCvRefTo) { using arene::base::give_cvref_to; }
/// @test `give_cvref_to_t` is declared
TEST(TypeTraits, GiveCvRefToT) { using arene::base::give_cvref_to_t; }
