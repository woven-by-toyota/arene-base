...
// As of writing, there's no Cartesian product available for arene::base::type_list so we have to write this by hand.
using test_types = ::testing::Types<
    test_param<isfinite_fixture, float>,
    test_param<isfinite_fixture, double>,
    test_param<isnormal_fixture, float>,
    test_param<isnormal_fixture, double>,
    test_param<isinf_fixture, float>,
    test_param<isinf_fixture, double>,
    test_param<isnan_fixture, float>,
    test_param<isnan_fixture, double>>;
