...
/// @brief provides unit tests for static_assertions_enabled.hpp
///
...
/// @test `STATIC_ASSERT_EQ` compiles OK
...
/// @test `STATIC_ASSERT_NE` compiles OK
...
/// @test `STATIC_ASSERT_LT` compiles OK
...
/// @test `STATIC_ASSERT_LE` compiles OK
...
/// @test `STATIC_ASSERT_GT` compiles OK
...
/// @test `STATIC_ASSERT_GE` compiles OK
...
/// @test `STATIC_ASSERT_TRUE` compiles OK
...
/// @test `STATIC_ASSERT_FALSE` compiles OK
...
/// @test `STATIC_ASSERT_NEAR` compiles OK
...
/// @test `STATIC_ASSERT_STREQ` compiles OK
...
/// @test `STATIC_ASSERT_STRNE` compiles OK
