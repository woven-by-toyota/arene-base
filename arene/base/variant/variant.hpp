...
class variant : full_ordering_operators_from_less_than_and_equals<variant<Ts...>> {
  ...
  using copy_ctor_arg =
      std::conditional_t<base::all_of_v<std::is_copy_constructible<Ts>::value...>, variant, non_constructible_dummy>;
  // parasoft-end-suppress AUTOSAR-A2_10_1-e
  ...
  using dummy_copy_ctor_source =
      std::conditional_t<base::all_of_v<std::is_copy_constructible<Ts>::value...>, non_constructible_dummy, variant>;
  // parasoft-end-suppress AUTOSAR-A2_10_1-e
  ...
  using move_ctor_arg =
      std::conditional_t<base::all_of_v<std::is_move_constructible<Ts>::value...>, variant, non_constructible_dummy>;
  // parasoft-end-suppress AUTOSAR-A2_10_1-e
  ...
  using dummy_move_ctor_source =
      std::conditional_t<base::all_of_v<std::is_move_constructible<Ts>::value...>, non_constructible_dummy, variant>;
  // parasoft-end-suppress AUTOSAR-A2_10_1-e
