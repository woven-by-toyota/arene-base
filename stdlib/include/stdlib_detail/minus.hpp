...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MINUS_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MINUS_HPP_
...
class minus {
 public:
  ...
  using result_type = T;
  /// @brief Type of the first value to subtract
  using first_argument_type = T;
  /// @brief Type of the second value to subtract
  using second_argument_type = T;

  /// @brief Returns the first value minus the second value
  /// @tparam U Template parameter to enable constraints.
  /// @param lhs The first value to subtract
  /// @param rhs The second value to subtract
...
/// @brief Function object that can be invoked for subtraction, specialized for type deduction
template <>
class minus<void> {
 public:
  // parasoft-begin-suppress AUTOSAR-A2_10_1-e "False positive: 'is_transparent' does not hide an identifier in 'minus'"
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MINUS_HPP_
