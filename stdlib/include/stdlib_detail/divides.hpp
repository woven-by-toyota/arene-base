...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_DIVIDES_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_DIVIDES_HPP_
...
/// @brief Function object for performing division.
...
class divides {
 public:
  ...
  using result_type = T;
  /// @brief Type of the first value to divide
  using first_argument_type = T;
  /// @brief Type of the second value to divide
  using second_argument_type = T;

  /// @brief Returns the first value divided by second value
...
/// @brief Function object that can be invoked for division, specialized for type deduction
template <>
class divides<void> {
 public:
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_DIVIDES_HPP_
