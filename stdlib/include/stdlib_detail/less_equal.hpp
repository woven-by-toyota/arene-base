...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_LESS_EQUAL_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_LESS_EQUAL_HPP_
...
/// @brief Function object that can be invoked for less than or equal to comparisons
...
class less_equal {
 public:
  ...
  /// @brief Returns if the first value is less than or equal to the second
...
/// @brief Function object that can be invoked for less than or equal to comparisons, specialized for type deduction
template <>
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_LESS_EQUAL_HPP_
