...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MODULUS_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MODULUS_HPP_
...
/// @brief Function object for performing modulus.
...
class modulus {
 public:
  ...
  using result_type = T;
  /// @brief Type of the first value to modulus
  using first_argument_type = T;
  /// @brief Type of the second value to modulus
  using second_argument_type = T;

  /// @brief Returns the remainder of the first value divided by second value
  /// @tparam U Template parameter to enable constraints.
  /// @param lhs The first value to divide
  /// @param rhs The second value to divide
...
/// @brief Function object that can be invoked for modulus, specialized for type deduction
template <>
class modulus<void> {
 public:
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MODULUS_HPP_
