...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_LOGICAL_OR_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_LOGICAL_OR_HPP_
...
/// @brief Function object for performing logical OR (logical disjunction). Effectively calls @c operator|| on type @c
/// T.
...
class logical_or {
 public:
  ...
  /// @brief Type of the first value to logically OR (deprecated in C++17)(removed in C++20)
  using first_argument_type = T;
  /// @brief Type of the second value to logically OR (deprecated in C++17)(removed in C++20)
  using second_argument_type = T;

  ARENE_IGNORE_START();
  ARENE_IGNORE_ARMCLANG("-Wnull-conversion", "The standard expects the conversions here");
  /// @brief Returns the logical OR of @c lhs and @c rhs.
  /// @tparam U Template parameter to enable constraints.
  /// @param lhs The first value to compute logical OR of
  /// @param rhs The second value to compute logical OR of
  ...
  constexpr auto operator()(T const& lhs, T const& rhs) const                   //
      ...
      -> bool {
    // parasoft-begin-suppress AUTOSAR-M5_3_1-a "False positive: operator|| accepts non-bool types in std::logical_or"
    return lhs || rhs;
...
/// @brief Function object for performing logical OR (logical conjunction), specialized for deduction of parameter and
/// return type.
template <>
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_LOGICAL_OR_HPP_
