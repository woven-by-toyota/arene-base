...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MAKE_UNSIGNED_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MAKE_UNSIGNED_HPP_
...
struct make_unsigned<
    ...
    arene::base::constraints<
        ...
        enable_if_t<!is_volatile_v<Type>>>> {
  /// @brief The resulting type
  using type = add_const_t<typename make_unsigned<remove_cv_t<Type>>::type>;
};
...
struct make_unsigned<
    ...
    arene::base::constraints<
        ...
        enable_if_t<!is_const_v<Type>>>> {
  /// @brief The resulting type
  using type = add_volatile_t<typename make_unsigned<remove_cv_t<Type>>::type>;
};
...
struct make_unsigned<
    ...
    arene::base::constraints<
        ...
        enable_if_t<is_volatile_v<Type>>>> {
  /// @brief The resulting type
  using type = add_const_t<add_volatile_t<typename make_unsigned<remove_cv_t<Type>>::type>>;
};
...
struct sized_unsigned<Size, arene::base::constraints<enable_if_t<Size == sizeof(char)>>> {
  /// @brief The resulting type
  using type = unsigned char;
};
...
template <size_t Size>
// NOLINTNEXTLINE(google-runtime-int)
struct sized_unsigned<Size, arene::base::constraints<enable_if_t<Size == sizeof(short)>>> {
  /// @brief The resulting type
  // NOLINTNEXTLINE(google-runtime-int)
  using type = unsigned short;
};
...
struct make_unsigned<
  ...
  /// @brief The resulting type
  using type = typename sized_unsigned<sizeof(Type)>::type;
};
...
template <typename Type>
using make_unsigned = make_unsigned_detail::make_unsigned<Type>;
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MAKE_UNSIGNED_HPP_
