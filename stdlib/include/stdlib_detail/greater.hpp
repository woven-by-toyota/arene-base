...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_GREATER_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_GREATER_HPP_
...
/// @brief Function object that can be invoked for greater than comparisons
...
class greater {
 public:
  ...
  /// @brief Returns if the first value is greater than the second
...
/// @brief Function object that can be invoked for greater than comparisons, specialized for type deduction
template <>
class greater<void> {
 public:
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_GREATER_HPP_
