...
#ifndef INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MULTIPLIES_HPP_
#define INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MULTIPLIES_HPP_
...
class multiplies {
 public:
  ...
  using result_type = T;
  /// @brief Type of the first value to multiply
  using first_argument_type = T;
  /// @brief Type of the second value to multiply
  using second_argument_type = T;

  /// @brief Returns the first value multiplied by second value
...
/// @brief Function object that can be invoked for multiplication, specialized for type deduction
template <>
...
#endif  // INCLUDE_GUARD_ARENE_BASE_STDLIB_INCLUDE_STDLIB_DETAIL_MULTIPLIES_HPP_
